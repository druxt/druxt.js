...
it('Storybook: DruxtJS', () => {
  ...
  cy.get('#druxt-druxtmodule--page')
    .should('contain.text', 'DruxtModule')
    .click()
  cy.url().should('contain', '?path=/story/druxt-druxtmodule--page')

  // Test the DruxtDebug story.
  cy.get('#druxt-druxtdebug')
    .should('contain.text', 'DruxtDebug')
    .click()
...
it('Storybook: Blocks', () => {
  ...
  cy.get('#druxt-blocks-druxtblock')
    .should('contain.text', 'DruxtBlock')
    .click()
  ...
  cy.get('#druxt-blocks-druxtblockregion')
    .should('contain.text', 'DruxtBlockRegion')
    .click()
...
it('Storybook: Router', () => {
  ...
  cy.get('#druxt-router')
    .should('contain.text', 'Router')
    .click()

  // Test the DruxtRouter group.
  cy.get('#druxt-router-druxtrouter')
    .should('contain.text', 'DruxtRouter')
    .click()
...
it('Storybook: Breadcrumb', () => {
  ...
  cy.get('#druxt-breadcrumb')
    .should('contain.text', 'Breadcrumb')
    .click()

  // Test the DruxtBreadcrumb group.
  cy.get('#druxt-breadcrumb-druxtbreadcrumb')
    .should('contain.text', 'DruxtBreadcrumb')
    .click()
...
it('Storybook: Entity', () => {
  ...
  cy.get('#druxt-entity-druxtentity')
    .should('contain.text', 'DruxtEntity')
    .click()
  ...
  cy.get('#druxt-entity-druxtentityform')
    .should('contain.text', 'DruxtEntityForm')
    .click()
  ...
  // Test the Node group.
  cy.get('#druxt-entity-node')
    .should('contain.text', 'Node')
    .click()
  cy.get('[data-parent-id="druxt-entity-node"]')
    .should('have.length', 3)
  cy.get('[data-parent-id="druxt-entity-node"]:last')
    .should('have.text', 'Recipe')
    .click()

  // Test view displays.
  cy.get('#druxt-entity-node-recipe-view-displays')
    .should('exist')
    .click()
  ...
  // Test view displays.
  cy.get('#druxt-entity-node-recipe-form-displays')
    .should('exist')
    .click()
  cy.get('#control-uuid').select('Vegan chocolate and nut brownies (444d06fc-f4bc-435e-9892-d7e719957ecc)')
})
...
it('Storybook: Menu', () => {
  ...
  cy.get('#druxt-menu-druxtmenu')
    .should('contain.text', 'DruxtMenu')
    .click()
  ...
  cy.get('#druxt-menu-user-account-menu--default')
    .should('contain.text', 'User account menu')
    .click()
...
it('Storybook: Views', () => {
  ...
  cy.get('#druxt-views')
    .should('contain.text', 'Views')
    .click()
  cy.get('[data-parent-id="druxt-views"]').should('have.length', 7)

  // Test the DruxtView group.
  cy.get('#druxt-views-druxtview')
    .should('contain.text', 'DruxtView')
    .click()
  ...
  cy.get('#druxt-views-recipes')
    .should('contain.text', 'Recipes')
    .click()
...
it('Storybook: Site', () => {
  ...
  cy.get('#druxt-site-druxtsite')
    .should('contain.text', 'DruxtSite')
    .click()
  ...
  cy.get('#druxt-site-themes')
    .should('contain.text', 'Themes')
    .click()
  cy.get('[data-parent-id="druxt-site-themes"]').should('have.length', 2)

  // Test the Seven site.
  cy.get('#druxt-site-themes-seven--default')
    .should('contain.text', 'Seven')
    .click()
