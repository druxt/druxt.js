<template>
  <div v-if="!$fetchState.pending">
    ...
    <blockquote>The DruxtWrapper is a theming component that wraps the DruxtModule output. The following examples demonstrate different ways it can be used.</blockquote>
    ...
    <p>This will ignore any available wrapper components and renders the default output of the DruxtEntity module.</p>
    ...
    <p>The value of the template will be the output of the component, wrapper component is ignored.</p>
    <details>
      <summary><strong>Output</strong></summary>
      <DruxtEntity :type="type" :uuid="uuid">
    ...
    <p>The value of the template will be the output of the default slot in a wrapper component.</p>
    <details>
      <summary><strong>Output</strong></summary>
