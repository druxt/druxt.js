...
export default {
  ...
  // without colliding - and without start-server-and-test polling the
  // wrong app.
  server: { port: 3001 },
  generate: { routes: ['/'] },
  telemetry: true,
  ...
  // viewport, then scaled the whole thing down to fit, so a design that's
  // mobile-first by intent looked small and cramped on an actual phone.
  head: {
