 ...
 */
const SECTIONS = {
  tutorials: { label: 'Tutorial', plural: 'Tutorials', icon: 'tutorials', mono: false },
  'how-to': { label: 'How-to', plural: 'How-to guides', icon: 'howTo', mono: false },
  explanation: { label: 'Concept', plural: 'Concepts', icon: 'explanation', mono: false },
 ...
 * @param {string} page.section - A SECTIONS key; unknown keys render as tutorials.
...
function ogCard(page) {
  const section = SECTIONS[page.section] || SECTIONS.tutorials
...
module.exports = { ogCard, SECTIONS, SECTION_ICON_PATHS, MODULE_ICON_PATHS, LOGO_PATHS }
