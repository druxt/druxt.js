...
describe('Component - DruxtFieldTextTrimmed', () => {
  test('default', async () => {
    ...
    expect(consoleWarnSpy).toHaveBeenCalledWith('[druxt-entity] The DruxtFieldTextTrimmed component is deprecated. See https://entity.druxtjs.org/guide/deprecations.html')
    ...
    expect(consoleWarnSpy2).toHaveBeenCalledWith('[druxt-entity] The DruxtFieldTextTrimmed component is deprecated. See https://entity.druxtjs.org/guide/deprecations.html')
