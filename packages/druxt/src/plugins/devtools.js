            ...
            data: {
              ...
              settings: {
                ...
                props: Object.entries(
                  payload.componentInstance.component.propsData || {}
      ...
      setupDevtoolsPlugin(
        ...
        (api) => {
          ...
          api.on.inspectComponent((payload) => {
            if (
              payload.instanceData.state &&
              payload.componentInstance.component
            ) {
              payload.instanceData.state.push({
                ...
                value: {
                  _custom: {
                    ...
                    value: payload.componentInstance.component.options.map(
                      (option) => ({
                        _custom: {
                          type: null,
                          display: option,
                          actions: !payload.componentInstance.$nuxt.$options
                            .components[option]
